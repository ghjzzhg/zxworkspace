...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			//判断密码不能为空
			var input_pwd = $("#txtNewPass").val();
			var re_pwd = $("#txtRePass").val();
			if (input_pwd == null) {
			...
			//判断密码中不包含空白字符
			var reg = /\s+/;//空白字符为\s
			if (reg.test(input_pwd)) {
				$.messager.alert('警告','密码中不可含有空白字符','warning');
				return;
			}
			//密码位数确认
			if (input_pwd.length < 6 || input_pwd.length > 10) {
				$.messager.alert('警告','密码的长度为6-10位','warning');
				return;
			}
			//两次密码不一致
			if (input_pwd != re_pwd) {
	...
	function showAbout(){
		//调用qq发起聊天
	    location.href="tencent://message/?uin=3077008731";
		
// 		$.messager.alert("中喜BOS v1.0","设计: 谷宏江<br/><br/> 管理员邮箱: ghjzzhg@163.com <br/><br/> QQ:");
	}
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							中喜 | Powered by <a href="http://www.资秘网.com/">资秘网.com</a>
						</div>
					</td>
