...
import cn.zx.ghjmaven.action.data.FunctionUtils;
import cn.zx.ghjmaven.action.data.VisitedUrlQueue;
    ...
    public static String getContentFormUrl(String url) {  
        ...
        try {  
            ...
            if (entity != null) {
                ...
                /* 判断是否符合下载网页源代码到本地的条件 */
                boolean createFile = FunctionUtils.isCreateFile(url);
                int hasGoalContent = FunctionUtils.isHasGoalContent(content);
                System.out.println(createFile);
                System.out.println(hasGoalContent);
